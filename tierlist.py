...
class Main():
    def starting():
        ...
        button1 = Button(root , text="Open a tierlist.." , font=("Fira Mono" , 12) , bg="darkorchid2" , fg="floralwhite")
        canvas.delete('all')
...
Generated by TierlistTK \n'''
    ...
    def open():
        ...
        try:
            if content[8] == "Generated by TierlistTK":
                root.title(f"{content[1]} - TierlistTK")
                entrys.insert(END,f"{content[2]}")
                entrya.insert(END,f"{content[3]}")
                entryb.insert(END,f"{content[4]}")
                entryc.insert(END,f"{content[5]}")
                entryd.insert(END,f"{content[6]}")
            else:
